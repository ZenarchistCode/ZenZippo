class CAContinuousQuantityLiquidTransferZenZippo : CAContinuousBase
{
	...
	void CAContinuousQuantityLiquidTransferZenZippo(float quantity_used_per_second, float time_to_progress, int drain = -1) //-1 used as a safeguard; if no valid value arrives, callback is canceled
	{
